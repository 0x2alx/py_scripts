...
<p align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/0x2alx/py_scripts/tree/opensea_tweet_bot"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/ncvanegmond/tweet_opensea_sale_bot">OG Code</a>
    ·
    <a href="https://github.com/0x2alx/py_scripts/issues">Report Bug</a>
    ·
    <a href="https://github.com/0x2alx/py_scripts/issues">Request Feature</a>
  </p>
</p>
...
2. Clone the repo
   ```sh
   git clone https://github.com/0x2alx/py_scripts.git
   ```
   ```sh
...
[contributors-url]: https://github.com/0x2alx
